      ...
      <img src={logo} className="App__logo" alt='Game Logo'/>
       ...
       <div className="App__characters">
         {isGameOn ? (
           <Card
             playerCard={true}
             character={characters.filter(character => character.name === gameState.currentCard.player)}
         ...
         {isGameOn ? (
           <Card
             playerCard={false}
             character={characters.filter(character => character.name === gameState.currentCard.computer)}
